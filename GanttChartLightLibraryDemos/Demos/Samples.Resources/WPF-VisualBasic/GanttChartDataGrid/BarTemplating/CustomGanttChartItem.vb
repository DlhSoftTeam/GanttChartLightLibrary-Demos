...
Friend Class CustomGanttChartItem
    ...
    Private markers_Value As New ObservableCollection(Of Marker)()
    ...
    Public ReadOnly Iterator Property ComputedInterruptedBars() As IEnumerable(Of InterruptedBar)
        Get
            Dim interruptionsValue = From i In Interruptions
                                     Where (i.ComputedLeft > 0 OrElse i.ComputedLeft + i.ComputedWidth > 0) AndAlso (i.ComputedLeft < ComputedBarWidth OrElse i.ComputedLeft + i.ComputedWidth < ComputedBarWidth) Order By i.ComputedLeft
                                     Select i
