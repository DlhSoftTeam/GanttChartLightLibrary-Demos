...
Partial Public Class MainWindow
		...
		Private Sub ZoomLevelTextBox_TextChanged(sender As Object, e As System.Windows.Controls.TextChangedEventArgs)
			If GanttChartDataGrid Is Nothing Then
				Return
			End If
			Dim hourWidth As Double
			If Double.TryParse(ZoomLevelTextBox.Text.Trim(), hourWidth) Then
				If hourWidth > 0 Then
    ...
    Private Sub DisableMouseWheelZoomCheckBox_Checked(sender As Object, e As RoutedEventArgs)
        If GanttChartDataGrid Is Nothing Then
            Return
        End If
        GanttChartDataGrid.IsMouseWheelZoomEnabled = CBool(Not DisableMouseWheelZoomCheckBox.IsChecked)
    End Sub
