...
Partial Public Class MainWindow
    ...
    Public Sub New()
        ...
        item1.MinStart = Date.Today.AddDays(-1).Add(TimeSpan.Parse("08:00:00"))
        item1.MaxStart = Date.Today.AddDays(1).Add(TimeSpan.Parse("08:00:00"))
        item1.Finish = Date.Today.Add(TimeSpan.Parse("16:00:00"))
        item1.MinFinish = Date.Today.AddDays(-1).Add(TimeSpan.Parse("16:00:00"))
        item1.MaxFinish = Date.Today.AddDays(1).Add(TimeSpan.Parse("16:00:00"))
        ...
        item2.MinStart = Date.Today.Add(TimeSpan.Parse("08:00:00"))
        item2.MaxStart = Date.Today.Add(TimeSpan.Parse("08:00:00"))
        item2.Finish = Date.Today.AddDays(2).Add(TimeSpan.Parse("16:00:00"))
        item2.MinFinish = Date.Today.AddDays(1).Add(TimeSpan.Parse("16:00:00"))
        item2.MaxFinish = Date.Today.AddDays(3).Add(TimeSpan.Parse("16:00:00"))
        ...
        item4.MinStart = Date.Today.AddDays(-1).Add(TimeSpan.Parse("08:00:00"))
        item4.MaxStart = Date.Today.AddDays(1).Add(TimeSpan.Parse("08:00:00"))
        item4.Finish = Date.Today.AddDays(2).Add(TimeSpan.Parse("12:00:00"))
        item4.MinFinish = Date.Today.AddDays(1).Add(TimeSpan.Parse("12:00:00"))
        item4.MaxFinish = Date.Today.AddDays(3).Add(TimeSpan.Parse("12:00:00"))

        Dim item6 As GanttChartItem = GanttChartDataGrid.Items(6)
        item6.Start = Date.Today.Add(TimeSpan.Parse("08:00:00"))
        item6.MinStart = Date.Today.AddDays(-1).Add(TimeSpan.Parse("08:00:00"))
        item6.MaxStart = Date.Today.AddDays(1).Add(TimeSpan.Parse("08:00:00"))
        item6.Finish = Date.Today.AddDays(3).Add(TimeSpan.Parse("12:00:00"))
        item6.MinFinish = Date.Today.AddDays(2).Add(TimeSpan.Parse("16:00:00"))
        item6.MaxFinish = Date.Today.AddDays(4).Add(TimeSpan.Parse("16:00:00"))

        Dim item7 As GanttChartItem = GanttChartDataGrid.Items(7)
        item7.Start = Date.Today.AddDays(4)
        item7.MinStart = Date.Today.AddDays(2)
        item7.MaxStart = Date.Today.AddDays(6)
        ...
        For i As Integer = 3 To 25
            GanttChartDataGrid.Items.Add(New GanttChartItem With {.Content = "Task " & i, .Indentation = If(i Mod 3 = 0, 0, 1), .Start = Date.Today.AddDays(If(i <= 8, (i - 4) * 2, i - 8)), .MinStart = Date.Today.AddDays(If(i <= 8, (i - 4) * 2, i - 8)).AddDays(-2), .MaxStart = Date.Today.AddDays(If(i <= 8, (i - 4) * 2, i - 8)).AddDays(2), .Finish = Date.Today.AddDays((If(i <= 8, (i - 4) * 2 + (If(i > 8, 6, 1)), i - 2)) + 2), .MinFinish = Date.Today.AddDays((If(i <= 8, (i - 4) * 2 + (If(i > 8, 6, 1)), i - 2)) + 2).AddDays(1), .MaxFinish = Date.Today.AddDays((If(i <= 8, (i - 4) * 2 + (If(i > 8, 6, 1)), i - 2)) + 2).AddDays(3)})
        Next i
