...
namespace Demos.WPF.CSharp.GanttChartDataGrid.ZoomLevel
{
    /// <summary>
    ...
    public partial class MainWindow : Window
    {
        ...
        private void ZoomLevelTextBox_TextChanged(object sender, System.Windows.Controls.TextChangedEventArgs e)
        {
            if (GanttChartDataGrid == null)
                return;
            double hourWidth;
            if (double.TryParse(ZoomLevelTextBox.Text.Trim(), out hourWidth))
            {
                if (hourWidth > 0)
        ...
        private void DisableMouseWheelZoomCheckBox_Checked(object sender, RoutedEventArgs e)
        {
            if (GanttChartDataGrid == null)
                return;
            GanttChartDataGrid.IsMouseWheelZoomEnabled = (DisableMouseWheelZoomCheckBox.IsChecked == false);
        }
    }
}
