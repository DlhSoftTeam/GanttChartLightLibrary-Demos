...
Partial Public Class MainWindow
    ...
    Private Sub GanttChartDataGrid_ItemPropertyChanged(sender As Object, e As PropertyChangedEventArgs)
        If e.PropertyName.StartsWith("Actual") OrElse e.PropertyName.StartsWith("Computed") OrElse e.PropertyName.Contains("Index") Then
            Return
        End If
        Dim item = TryCast(sender, GanttChartItem)
        Dim message As String = String.Format("Property '{0}' of item '{1}' has changed.", e.PropertyName, item)
