...
Partial Public Class MainWindow
    ...
    Public Sub New()
        ...
        Dim predecessorItem1 As PredecessorItem = New PredecessorItem With {.Item = item1}
        ' Optionally, customize colors for specific dependency lines.
        GanttChartView.SetDependencyLineStroke(predecessorItem1, Brushes.Orange)
        item2.Predecessors.Add(predecessorItem1)
        ...
        ' Optionally, you can also set up values for custom properties (such as attached properties) bound to the user interface in dependency line template definition (XAML).
        Dim predecessorItem2 As PredecessorItem = New PredecessorItem With {.Item = item6}
        PredecessorItemExtensions.SetIsImportant(predecessorItem2, True)
        item7.Predecessors.Add(predecessorItem2)
        ...
        GanttChartDataGrid.DisplayedTime = Date.Today.AddDays(-1)
    End Sub
