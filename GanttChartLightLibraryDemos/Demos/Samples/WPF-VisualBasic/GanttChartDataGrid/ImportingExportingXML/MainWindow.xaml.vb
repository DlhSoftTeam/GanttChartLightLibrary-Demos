...
Partial Public Class MainWindow
    ...
    Private Sub SaveProjectXmlButton_Click(sender As Object, e As RoutedEventArgs)
        ...
        Dim saveFileDialog As SaveFileDialog = New SaveFileDialog With {.Title = "Save Project XML", .Filter = "Project XML files|*.xml", .DefaultExt = ".xml"}
    ...
    Private Sub LoadProjectXmlButton_Click(sender As Object, e As RoutedEventArgs)
        ...
        Dim openFileDialog As OpenFileDialog = New OpenFileDialog With {.Title = "Load Project XML", .Filter = "Project XML files|*.xml", .Multiselect = False}
