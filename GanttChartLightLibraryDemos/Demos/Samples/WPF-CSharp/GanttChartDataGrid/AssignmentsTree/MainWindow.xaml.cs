...
namespace Demos.WPF.CSharp.GanttChartDataGrid.AssignmentsTree
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void EditAssignmentsButton_Click(object sender, RoutedEventArgs e)
        {
            var element = sender as FrameworkElement;
            GanttChartItem item = element.DataContext as GanttChartItem;
            
            EditAssignmentsTreeDialog editAssignmentsTreeDialog = new EditAssignmentsTreeDialog { Owner = Application.Current.MainWindow, DataContext = item };
